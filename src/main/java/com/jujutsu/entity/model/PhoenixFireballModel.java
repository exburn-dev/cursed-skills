...
public class PhoenixFireballModel extends EntityModel<PhoenixFireballEntity> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData main = modelPartData.addChild("main", ModelPartBuilder.create().uv(0, 0).cuboid(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 24.0F, 0.0F));
