...
public record UpgradesData(Identifier upgradesId, float points, HashMap<Identifier, Identifier> purchasedUpgrades) {
    public static final Codec<UpgradesData> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            ...
            Codec.FLOAT.fieldOf("points").forGetter(UpgradesData::points),
    ...
    public static final PacketCodec<RegistryByteBuf, UpgradesData> PACKET_CODEC = PacketCodec.tuple(
            ...
            PacketCodecs.FLOAT, UpgradesData::points,
