...
public record AdditionalInputPressedPayload(RequestedInputKey additionalInput) implements CustomPayload {
    ...
    public static final PacketCodec<RegistryByteBuf, AdditionalInputPressedPayload> CODEC = PacketCodec.tuple(
            RequestedInputKey.PACKET_CODEC, AdditionalInputPressedPayload::additionalInput, AdditionalInputPressedPayload::new);
