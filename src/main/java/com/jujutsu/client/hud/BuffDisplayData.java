...
public record BuffDisplayData(RegistryEntry<EntityAttribute> attribute, BuffPredicate condition) {
    public static final Codec<BuffDisplayData> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            ...
            BuffPredicate.CODEC.fieldOf("condition").forGetter(BuffDisplayData::condition))
