...
public final class AbilityInstanceOld {
    public static final Codec<AbilityInstanceOld> CODEC;
    public static final PacketCodec<RegistryByteBuf, AbilityInstanceOld> PACKET_CODEC;
    public static final PacketCodec<RegistryByteBuf, AbilityInstanceOld> PACKET_CODEC_RUNTIME_DATA;
    ...
    public AbilityInstanceOld(AbilityType type) {
        this.type = type;
        this.slot = null;
    }

    private AbilityInstanceOld(AbilityType type, int useTime, int cooldownTime, AbilityStatus status) {
        this.type = type;
    ...
    static {
        ...
        PACKET_CODEC_RUNTIME_DATA = new PacketCodec<RegistryByteBuf, AbilityInstanceOld>() {
            @Override
    ...
    private static class AbilityInstanceCodec implements Codec<AbilityInstanceOld> {
        @Override
        public <T> DataResult<Pair<AbilityInstanceOld, T>> decode(DynamicOps<T> ops, T input) {
            ...
            AbilityInstanceOld instance = new AbilityInstanceOld(type, useTime, cooldownTime, status);

            return DataResult.success(new Pair<>(instance, input));
        }

        @Override
        public <T> DataResult<T> encode(AbilityInstanceOld instance, DynamicOps<T> ops, T t) {
